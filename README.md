...
- `net8.0-windows` — AutoCAD 2025–2026; по замеру 23.09.2026 сборка под `net8` с этим SDK
  загружается и работает и в AutoCAD 2027 / Civil 3D 2027 — объявляйте 2027 только проверив
  свой продукт на нём
...
> родной рантайм 2025–2026. Для `net10` — `R26.0`, это AutoCAD 2027. `net8`-сборка по нашему замеру
> грузится и в 2027, поэтому `R26.0` для неё — законный выбор, но ваш: портал предупредит «проверьте
> на 2027», а не откажет. Какая серия окажется у следующей версии AutoCAD, мы не выводим формулой —
