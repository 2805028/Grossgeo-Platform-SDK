...
namespace TestProduct.Subscription
{
    ...
    public class TestSubscriptionPlugin : IExtensionApplication
    {
        ...
        private static void RunOnMainThread(Action action)
        {
            ...
            if (ui == null)
            {
                System.Diagnostics.Debug.WriteLine("[TestProduct.Subscription] главный поток не запомнен в Initialize — вывод пропущен");
                return;
            }
        ...
        private static void RunSafely(Action action)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"[TestProduct.Subscription] {ex}");
            }
        }
